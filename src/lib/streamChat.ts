const CHAT_URL = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/research-query`;
...
export async function streamResearchChat({
  ...
  const resp = await fetch(CHAT_URL, {
    ...
    body: JSON.stringify({ message, diseaseContext, conversationHistory, userProfile }),
  });
